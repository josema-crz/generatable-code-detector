...
import generationcandidatesdetector.wizards.clonedetection.CloneDetectionWizard;

/**
 * Handler for the clone detection feature application.
 */
		...
		if (selection != null && selection instanceof IStructuredSelection) {
			...
			try {
				...
				WizardDialog wizardDialog = new WizardDialog(HandlerUtil.getActiveWorkbenchWindow(event).getShell(),
						new CloneDetectionWizard(selectedFiles));
