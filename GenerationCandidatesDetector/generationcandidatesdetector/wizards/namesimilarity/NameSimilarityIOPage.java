...
public class NameSimilarityIOPage extends WizardPage {
	...
	protected NameSimilarityIOPage(List<IFile> files) {
		super("Input/Output");
		setTitle("Input/Output");
		setDescription(
				"Set the directories and artifacts that will be used during the name similarity process.");
